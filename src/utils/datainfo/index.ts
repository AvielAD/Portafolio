...
export const infoProyectos: Array<infoproydto>= [
    {
        ...
        about_client: "Sistema gestion de ordenes de servicio.  Claves Acceso Demo.  Usuario: invitado@email.mx .   Contraseña: Invitado",
        objetive: "Plataforma pensada para gestionar un taller de reparación para dispositivos electronicos",
    ...
    },
    {
        ...
        about_client: "Sistema gestion de inventario.  Claves Acceso Demo.  Usuario: invitado@email.mx .   Contraseña: Invitado",
        objetive: "Plataforma pensada para gestionar flujo de inventario para productos perecederos con diferentes embalajes.",
        tools_tech: "Postgresql - .Net - EF Core - Docker - Nginx - VPS - NextJS - Vercel",
    ...
    },
    {
        ...
        url: 'https://localfix.softwarp.net',
        about_client: "",
